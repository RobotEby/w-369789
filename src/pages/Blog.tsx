  ...
  return (
    <PageLayout>
      ...
      <div className="container mx-auto px-4 py-16">
        <NewsSystem maxItems={9} autoRefresh={true} refreshInterval={900000} />
      </div>

      {/* Seção de Blog Posts Originais */}
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-black">Nossos Artigos</h2>
            <p className="text-xl text-gray-600">
              Conteúdo exclusivo da equipe CBAAP sobre estratégias e insights de marketing digital
            </p>
          </div>
